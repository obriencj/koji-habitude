...
I wrote a set of guidelines about unit testing as a prompt, and that was used to
generate the `tests.mdc` cursor rules. All of the unit tests and the test data
is generated by AI prompt. I ask it to focus on a particular segment of the code
at a time, usually in order from basic features to layered and more advanced
features.
